...
// Production: https://musicinsta-ai-973497466485.us-central1.run.app
// Local dev: http://127.0.0.1:8000
export const API_BASE = import.meta.env.VITE_API_BASE_URL || 'https://musicinsta-ai-973497466485.us-central1.run.app';
